...
func _process(_delta):
	if player.currentstate == ("peelslip") or player.currentstate == ("peelland") or player.currentstate == ("peelslipbounce"):
		if !animator.animation == ("judgement"):
			playanim("judgement")
	if player.currentstate == ("Mach2") or player.currentstate == ("mach_jump") or player.currentstate == ("MachTurn"):
		if !animator.animation == ("mach2"):
			playanim("mach2")
	if player.currentstate == ("Mach3"):
		if !animator.animation == ("mach3"):
			playanim("mach3")
	if player.currentstate == ("Idle") or player.currentstate == ("Air") or player.currentstate == ("Run"):
